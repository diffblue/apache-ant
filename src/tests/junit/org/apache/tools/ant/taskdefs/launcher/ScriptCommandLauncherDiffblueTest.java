...
public class ScriptCommandLauncherDiffblueTest {
  /**
   * Test {@link ScriptCommandLauncher#exec(Project, String[], String[], File)} with {@code project}, {@code cmd}, {@code env}, {@code workingDir}.
   * <ul>
   *   <li>Given {@link AntClassLoader#AntClassLoader()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ScriptCommandLauncher#exec(Project, String[], String[], File)}
   */
  @Test
  public void testExecWithProjectCmdEnvWorkingDir_givenAntClassLoader() throws IOException {
    // Arrange
    ScriptCommandLauncher scriptCommandLauncher = new ScriptCommandLauncher("Script", new CommandLauncher());

    Project project = new Project();
    project.addBuildListener(new AntClassLoader());

    // Act and Assert
    assertThrows(IOException.class, () -> scriptCommandLauncher.exec(project, new String[]{"Cmd"}, new String[]{"Env"},
  ...
  public void testExecWithProjectCmdEnvWorkingDir_whenNull_thenThrowIOException() throws IOException {
    ...
    // Act and Assert
    assertThrows(IOException.class, () -> scriptCommandLauncher.exec(null, new String[]{"Cmd"}, new String[]{"Env"},
        Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile()));
  }
